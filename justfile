check:
	cd ./crate/ && cargo c --target=aarch64-apple-ios
	cd ./crate/ && cargo clippy --target=aarch64-apple-ios
	cd bevy_ios_gamecenter_egui && cargo clippy
	cd bevy_ios_gamecenter_egui && cargo clippy --target=aarch64-apple-ios

build-rust-release:
	cd ./crate/ && cargo build --release --target aarch64-apple-ios

build-rust:
	cd ./crate/ && cargo build --target aarch64-apple-ios
...
copy-generated:
	...
	if [ -f ./crate/generated/SwiftBridgeCore.swift ]; then \
...
build: build-rust copy-generated
	cp ./crate/target/aarch64-apple-ios/debug/libbevy_ios_gamecenter.a ./BevyIosGamecenterRust.xcframework/ios-arm64_x86_64-simulator/
...
build-release: build-rust-release copy-generated
	cp ./crate/target/aarch64-apple-ios/release/libbevy_ios_gamecenter.a ./BevyIosGamecenterRust.xcframework/ios-arm64_x86_64-simulator/
